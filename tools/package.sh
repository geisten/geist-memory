...
$digest Makefile mk/config.mk patches/*.patch patches/*.md .clang-format .gitattributes include/*.h src/*.[ch] \
    test/*.[ch] test/fixtures/*.h test/*.sh test/*.py examples/*.c tools/*.sh tools/*.py > "$root/SOURCE-SHA256SUMS"
